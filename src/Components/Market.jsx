    ...
    <>
      <div className='w-full bg-slate-900 flex border-t-2 border-slate-800'>
        <div
          ...
          className={`w-1/2 p-4 text-center font-semibold text-slate-50 text-xl cursor-pointer ${
            cardStyle === 'grid' ? 'border-b border-blue-700' : ''
          }`}
        >
          Grid
        </div>
        <div
          ...
          className={`w-1/2 p-4 text-center font-semibold text-slate-50 text-xl cursor-pointer ${
            cardStyle === 'list' ? 'border-b border-blue-700' : ''
          }`}
        >
          List
        </div>
